                ...
                <td className="px-4 py-3">
                  <span
                    className={
                      ...
                      (u.status === "ativo"
                        ? "gap-1.5 border-emerald-500/40 bg-emerald-500/10 text-emerald-400"
                        : "gap-1.5 border-red-500/40 bg-red-500/10 text-red-400")
                    }
                  >
                    <span
                      aria-hidden
                      className={
                        ...
                        (u.status === "ativo" ? "bg-emerald-400" : "bg-red-400")
                      }
                    />
