...
/*
 * `retryCrmWelcome` REMOVIDA (Comando 3): o primeiro contato tem
 * caminho único pelo Motor de Relacionamento (E0). Não existe reenvio
 * de boas-vindas por caminho legado.
 */
