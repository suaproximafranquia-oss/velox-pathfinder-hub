...
- [ ] Alavanca 1 de homologação — mover `cadence_activation_date` da Financeira para o marco oficial (2026-09-03), medindo a Ação do Dia antes/depois (sem reset destrutivo)
